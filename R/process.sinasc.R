...
#'
#' @param data Raw SINASC data generated by the function download.sinasc with all columns.
#' @seealso \code{\link{download.sinasc} \link{panel.sinasc}}
...
process.sinasc <- function(data){
  ...
  base$VINCULO <- ifelse(base$CODESTAB %in% hospital_universitario_ebserh$CNES,"EBSERH","Outros")
